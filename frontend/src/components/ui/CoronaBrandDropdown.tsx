...
import { ChevronDown, Bot, Settings, User, LogOut, Bell, HelpCircle } from 'lucide-react'
import { useCoronaDesign } from '../../contexts/CoronaDesignContext'

interface CoronaBrandDropdownProps {
  isCollapsed?: boolean
}

export const CoronaBrandDropdown: React.FC<CoronaBrandDropdownProps> = ({ isCollapsed = false }) => {
    ...
    <div style={containerStyles} ref={dropdownRef}>
      ...
      >
        <div style={logoStyles}>
          <Bot size={isCollapsed ? 16 : 20} />
        </div>
        <span style={brandTextStyles}>AgentFlow</span>
...
export default CoronaBrandDropdown
